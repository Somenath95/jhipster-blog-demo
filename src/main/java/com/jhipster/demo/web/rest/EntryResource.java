...
import com.jhipster.demo.domain.Entry;
import com.jhipster.demo.repository.EntryRepository;
...
/**
 * REST controller for managing {@link com.jhipster.demo.domain.Entry}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class EntryResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
     *         the updated entry, or with status {@code 400 (Bad Request)} if the
     *         entry is not valid, or with status {@code 404 (Not Found)} if the
     *         entry is not found, or with status
     *         {@code 500 (Internal Server Error)} if the entry couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
